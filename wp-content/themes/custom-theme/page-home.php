...
<section class="slider clear" style="position: relative;bottom: 0px;">
    <div class="large-12 columns">
        <?php 
            $slider_data = $wpdb->get_results("SELECT  meta_value FROM wp_postmeta WHERE post_id =68 AND meta_key ='nivo_settings' LIMIT 1"); 
...
<section class="services clear" style="background-color: white;">
  <div class="container home">
    <h2 class="uppercase">Proin suscipit luctus orci placerat</h2>
    <br/>
    <div class="row">
      <?php    
          $args = array(
